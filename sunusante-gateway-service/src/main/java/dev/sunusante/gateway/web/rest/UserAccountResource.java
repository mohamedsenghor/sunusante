...
/**
 * REST controller for managing {@link dev.sunusante.gateway.domain.UserAccount}.
 */
@RestController
...
public class UserAccountResource {
     ...
     */
    @PostMapping("")
    public Mono<ResponseEntity<UserAccountDTO>> createUserAccount(@RequestBody UserAccountDTO userAccountDTO) throws URISyntaxException {
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<UserAccountDTO>> getUserAccount(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteUserAccount(@PathVariable("id") Long id) {
