...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PATIENTCONSENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PATIENTCONSENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PATIENTCONSENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PATIENTCONSENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PATIENTCONSENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PATIENTCONSENT actions', async () => {
      const arg = 42666;
