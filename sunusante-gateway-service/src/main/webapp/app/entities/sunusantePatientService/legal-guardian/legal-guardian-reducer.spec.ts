...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEGALGUARDIAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEGALGUARDIAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEGALGUARDIAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEGALGUARDIAN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEGALGUARDIAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEGALGUARDIAN actions', async () => {
      const arg = 42666;
