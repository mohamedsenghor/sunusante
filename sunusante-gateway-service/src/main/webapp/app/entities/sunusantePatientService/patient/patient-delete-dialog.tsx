...
export const PatientDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sunusanteGatewayServiceApp.sunusantePatientServicePatient.delete.question">
        <Translate
          contentKey="sunusanteGatewayServiceApp.sunusantePatientServicePatient.delete.question"
          interpolate={{ id: patientEntity.id }}
        >
