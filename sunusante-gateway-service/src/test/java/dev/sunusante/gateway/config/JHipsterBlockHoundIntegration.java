package dev.sunusante.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("dev.sunusante.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("dev.sunusante.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
