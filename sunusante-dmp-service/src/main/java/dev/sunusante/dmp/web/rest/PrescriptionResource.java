...
import dev.sunusante.dmp.service.PrescriptionService;
...
/**
 * REST controller for managing {@link dev.sunusante.dmp.domain.Prescription}.
 */
@RestController
...
public class PrescriptionResource {
    ...
    private static final String ENTITY_NAME = "sunusanteDmpServicePrescription";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<PrescriptionDTO>> getAllPrescriptions(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
